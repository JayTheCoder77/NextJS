    ...
    >
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-2xl p-8">
        ...
        <p className="text-lg text-gray-700 mb-8 max-w-2xl">
          Customize your account settings , Profile , Notifications here. Chose
          option from sidebar to begin
        </p>
        <div className="flex space-x-12">
          ...
          <div className="flex-1 bg-white shadow-md rounded-lg p-8">
            ...
            <p className="text-lg text-gray-600 max-w-3xl">
              Choose option from sidebar to manage account notifications or
              profile settings
            </p>
          </div>
        </div>
